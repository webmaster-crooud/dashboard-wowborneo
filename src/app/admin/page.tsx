    ...
    return (
        <section className="min-h-screen">
            ...
            <section className="grid grid-cols-3 my-10 px-8 gap-6">
                ...
                <Card title="Logs">
                    <div className="bg-transparent text-sm text-gray-600">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempora, reprehenderit dignissimos quos similique omnis fugit eaque!
                        Inventore possimus corporis aliquid rerum distinctio neque, assumenda minus dolor, rem doloremque asperiores unde
                    </div>
                </Card>
            </section>
        </section>
